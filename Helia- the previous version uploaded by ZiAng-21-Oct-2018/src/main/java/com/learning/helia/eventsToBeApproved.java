...
public class eventsToBeApproved extends AppCompatActivity {
    ...
    public void initEventToBe1(){
        ...
        eventToBe1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent eventToBe1 = new Intent(eventsToBeApproved.this, eventDetailToBe.class);
    ...
    public void initEventToBe2(){
        ...
        eventToBe2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent eventToBe2 = new Intent(eventsToBeApproved.this, eventDetailToBe.class);
    ...
    public void initEventToBe3(){
        ...
        eventToBe3.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent eventToBe3 = new Intent(eventsToBeApproved.this, eventDetailToBe.class);
